...
class TestGraphCreation:
    ...
    def test_create_graph(self):
        ...
        graph = create_resolution_graph(use_mock=True)
...
class TestMockResolution:
    ...
    def test_mock_resolution_produces_applet(self):
        """Mock resolution should produce an applet."""
    ...
    def test_mock_resolution_has_trigger_action(self):
        """Mock resolution applet should have trigger and action."""
        result = run_resolution(
            query="When darkness detected, log to spreadsheet",
            use_mock=True,
            use_simple=True,
    ...
    def test_mock_resolution_has_bindings(self):
        """Mock resolution applet should have bindings."""
        result = run_resolution(
            query="When darkness detected, log to spreadsheet",
            use_mock=True,
            use_simple=True,
...
class TestStateFlow:
    """Tests for state transitions during resolution."""
    ...
    def test_candidates_loaded(self):
        ...
        graph = create_resolution_graph(use_mock=True, use_simple=True)
        compiled = compile_graph(graph, use_memory=False)

...
Defines the ResolutionState TypedDict used by LangGraph to track
the resolution process between agents.

WoT (Web of Things) Multi-Agent System:
    - Intent Analyzer: Decomposes query into sub-tasks
...
class CandidateInfo(TypedDict):
    ...
    Attributes:
        ...
        api_info: Operation-level configuration with ingredients/fields
...
class ResolutionState(TypedDict):
    """
    Main state for the resolution workflow.

    This state is persisted by LangGraph's checkpointer throughout
    the resolution session, enabling multi-turn interactions.
    ...
    Sections:
        ...
        Resolution: Current OFFER/REQUIREMENTS/bindings
        Result: Final output
    """
    ...
    # =========================================================================
    plan: Optional[Dict[str, Any]]           # Intent Analyzer's decomposition
    ...
    intent_analyzer_reasoning: Optional[str] # Intent Analyzer's chain-of-thought
    tool_calls: Optional[List[Dict[str, Any]]]  # Tool calls made by Intent Analyzer
    ...
    # =========================================================================
    # POSITION (Current resolution position)
    # =========================================================================
...
def create_initial_state(query: str) -> ResolutionState:
    """
    Create initial state for a new resolution session.

    Args:
        query: User query describing the desired applet.

    Returns:
        ResolutionState with default values.
    """
    return ResolutionState(
        ...
        intent_analyzer_reasoning=None,

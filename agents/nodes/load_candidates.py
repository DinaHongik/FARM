...
This node runs once at the start of each resolution session.
"""
...
def load_candidates_node(state: ResolutionState) -> Dict[str, Any]:
    """
    ...
    3. Stores top-K candidates in state for resolution
...
def load_candidates_mock(state: ResolutionState) -> Dict[str, Any]:
    """
...
def load_candidates_from_reference(state: ResolutionState) -> dict:
    """

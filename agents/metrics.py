...
class ResolutionMetrics:
    """
    Metrics for a single resolution session.
    ...
    # =========================================================================
    # REASONING FIELDS (for RAGAS evaluation)
    # =========================================================================
    intent_analyzer_reasoning: str = ""  # Chain-of-thought from Intent Analyzer
...
class MetricsTracker:
    """
    Tracks metrics across multiple resolution sessions.
    ...
    def __init__(self):
        ...
        self._sessions: List[ResolutionMetrics] = []

    def start_session(self, query: str, session_id: str = "") -> ResolutionMetrics:
        """
        ...
        Returns:
            ResolutionMetrics instance for this session
        """
    ...
    def end_session(self, metrics: ResolutionMetrics, state: Dict[str, Any]):
        """
        End a session and extract final metrics from state.

        Args:
            metrics: Metrics instance to update
            state: Final resolution state
        """
        ...
        metrics.first_pair_success = metrics.pairs_attempted == 1 and \
            state.get("resolution_status") == "accepted"
        ...
        # REASONING FIELDS (for RAGAS evaluation)
        # =====================================================================
        metrics.intent_analyzer_reasoning = state.get("intent_analyzer_reasoning", "")
        ...
        # Reasoning quality metrics
        all_reasoning = " ".join([
            metrics.intent_analyzer_reasoning,

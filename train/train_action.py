"""
Action Encoder Training with InfoNCE Loss
...
from .dataset import build_action_pairs
...
def train_action_encoder(cfg: TrainingConfig = None):
    """
    Train the action encoder using InfoNCE loss.
    ...
    print("=" * 60)
    print("FARM Action Encoder Training")
    print("=" * 60)
    print(f"Base model: {cfg.base_model}")
    print(f"Output dir: {cfg.action_output_dir}")
    ...
    train_dataset, val_dataset = build_action_pairs(
        cfg.applets_path,
    ...
    output_dir = cfg.project_root / cfg.action_output_dir
    ...
    json_logger = JSONLoggingCallback(cfg.action_logs_path)
    ...
    print(f"Logs:  {cfg.action_logs_path}")
    print("=" * 60)

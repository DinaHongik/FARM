...
def compute_context_precision(
    ...
    # Σ(Precision@k × v_k) / total_relevant
    precision_sum = 0.0
    true_positives = 0
...
Reasoning: {prediction.get('trigger_reasoning', '')} {prediction.get('action_reasoning', '')}"""
    ...
    # 7. Negotiation efficiency
    metrics.negotiation_rounds = prediction.get("pair_attempt", 0) + 1
    metrics.first_try_success = (metrics.goal_accuracy >= 0.5 and metrics.negotiation_rounds == 1)

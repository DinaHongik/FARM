...
def verifier_node(state: NegotiationState) -> Dict[str, Any]:
    """
    ...
    Args:
        state: Current negotiation state (must have accepted pair)

    Returns:
        State updates with verifier output and final applet
    """
    # Verify we have an accepted pair
    if state["negotiation_status"] != "accepted":
        return {
...
def _build_final_applet(
    ...
    return {
        ...
        "trigger": {
            ...
            "api_info": trigger.get("api_info", {}),  # Full API info for display
        ...
        "action": {
            ...
            "api_info": action.get("api_info", {}),  # Full API info for display
        ...
        "metadata": {
            "verifier_score": score,
            "verifier_critique": critique,
            "negotiation_rounds": pair_attempt,
            "is_executable": score >= config.verifier_threshold,
        },
    }


def verifier_simple(state: NegotiationState) -> Dict[str, Any]:
    """

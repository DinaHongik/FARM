...
def cross_scorer_node(state: NegotiationState) -> Dict[str, Any]:
    """
    ...
    3. Creates sorted priority queue for negotiation

    Args:
        state: Current negotiation state with candidates
...
def get_next_pair(state: NegotiationState) -> Optional[Tuple[int, int]]:
    """
...
def cross_scorer_simple(state: NegotiationState) -> Dict[str, Any]:
    """

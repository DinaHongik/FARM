...
def action_selector_node(state: NegotiationState) -> Dict[str, Any]:
    """
    ...
    if not verification_passed:
        ...
        return {
            ...
            "negotiation_status": "rejected",  # Signal to try next pair
...
def action_selector_simple(state: NegotiationState) -> Dict[str, Any]:

...
def trigger_agent_node(state: NegotiationState) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        # If LLM didn't extract ingredients, use API info directly
        if not ingredients:
        ...
        # Parsing failed - try to extract ingredients from API directly
        ingredients = extract_ingredients_from_api(trigger.get("api_info", {}))
...
def trigger_agent_simple(state: NegotiationState) -> Dict[str, Any]:
    """
    ...
    # Extract ingredients directly from API
    ingredients = extract_ingredients_from_api(trigger.get("api_info", {}))

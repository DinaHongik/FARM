...
from agents.errors import ParsingError, NegotiationError
...
def action_agent_node(state: NegotiationState) -> Dict[str, Any]:
    """
...
def action_agent_simple(state: NegotiationState) -> Dict[str, Any]:
    """
